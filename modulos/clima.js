...
const chaveOpenWeather = process.env.CHAVE_OPENWEATHER;

async function chamaClima (msg, client) {
    try {
        const cidade = "Sao Paulo";
        const apiUrl = `https://api.openweathermap.org/data/2.5/weather?q=${cidade}&lang=pt_br&units=metric&appid=${chaveOpenWeather}`;
